...
ReporticoApp::setConfig('project_title',"Maintenance");
...
ReporticoApp::setConfig('db_user',"app_maintenance");
ReporticoApp::setConfig('db_password',"=BtfnuU?+{n_");
ReporticoApp::setConfig('db_host',"127.0.0.1");
ReporticoApp::setConfig('db_database',"app_maintenance");
}
