...
$(function(){ 
	$(".btn-success").click(function () {	
            ...
            $.ajax ({
                type: 'POST',
				url: base_url + 'settings/cargarModalHazard',
                data: {'idHazard': oID},
                cache: false,
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-gear fa-fw"></i> SETTINGS - HAZARD
					</h4>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-medkit"></i> HAZARD LIST
				</div>
...
echo "<td class='text-center " . $class . "'><p class='text-" . $class . "'><strong>" . $priority . "</strong></p></td>";
						...
						?>
									<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="<?php echo $lista['id_hazard']; ?>" >
