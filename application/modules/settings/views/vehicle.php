...
$(function(){ 
	$(".btn-success").click(function () {	
            ...
            $.ajax ({
                type: 'POST',
				url: base_url + 'settings/cargarModalVehicle',
                data: {'idVehicle': oID},
                cache: false,
...
?>			
				...
				?>
					<ul class="nav nav-pills">
						<li <?php if($vehicleType == 1){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/1/1"); ?>">Pickup Trucks</a>
						</li>
						<li <?php if($vehicleType == 2){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/1/2"); ?>">Contruction Equipment</a>
						</li>
						<li <?php if($vehicleType == 3){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/1/3"); ?>">Trucks</a>
						</li>
						<li <?php if($vehicleType == 4){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/1/4"); ?>">Special Equipment</a>
						</li>
						<li <?php if($vehicleType == 99){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/1/99"); ?>">Survey - Trailer</a>
						</li>
						<li <?php if($vehicleState == 2){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/1/x/2"); ?>">Inactive Vehicles - VCI</a>
						</li>
					</ul>
				<?php
					}else{
				?>	
					<ul class="nav nav-pills">
						<li <?php if($vehicleState == 1){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/2/x/1"); ?>">Active Rental Vehicles</a>
						</li>
						<li <?php if($vehicleState == 2){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/vehicle/2/x/2"); ?>">Inactive Rental Vehicles</a>
						</li>
					</ul>
				<?php	
					}
