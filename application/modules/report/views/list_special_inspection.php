            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-purpura">
                        <div class="panel-heading">
							<a class="btn btn-purpura btn-xs" href=" <?php echo base_url().'report/searchByDateRange/specialInspection'; ?> "><span class="glyphicon glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Go back </a> 
	...
	<?php } ?>
						...
						<div class="col-lg-6">
							<div class="alert alert-danger">
								<strong>Record in Red: </strong>The inspection has comments or has some fails.
							</div>
						</div>
